...
namespace PassXYZ.Vault.ViewModels
{
    public class LoginViewModel : BaseViewModel
    {
        ...
        public LoginUser CurrentUser { get { return LoginUser.Instance; } }

        public ObservableCollection<User>? Users { get { return userService.Users; } }
        ...
        public LoginViewModel()
        {
            ...
            CurrentUser.PropertyChanged += (_, __) => LoginCommand.ChangeCanExecute();
            CurrentUser.PropertyChanged += (_, __) => SignUpCommand.ChangeCanExecute();
